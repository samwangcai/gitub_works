...
$from = "ad_articles.php?page=".$_GET['page'];
$id = 0;
$page = 1;
$type = "";
	...
	<div class="mainbody">
		...
		<form action="ad_editFuncs.php" method="post">
			...
			<table class="editTable" cellpadding="0" cellspacing="0" border="0">
				...
				<tr>
					<th>Context1:</td>
					<td><textarea name="context1"><? echo $data['context1']; ?></textarea></td>
				</tr>
				<tr>
					<th>Context2:</td>
					<td><textarea name="context2"><? echo $data['context2']; ?></textarea></td>
				</tr>
				<tr>
					<th>Context3:</td>
					<td><textarea name="context3"><? echo $data['context3']; ?></textarea></td>
				</tr>
			</table>
			<p></p>
			<p>
